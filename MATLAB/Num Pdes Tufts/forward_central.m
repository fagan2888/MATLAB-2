%Performs forward central finite difference method for u_t = -u_x. Input arguments are
...
function u = forward_central(t_nodes,x_nodes,init_cond,left_bcs,right_bcs,t_steps)
...
%Iterate the forward central scheme, at each time step plotting u vs x
for i=1:t_steps
    F(1) = lambda*l_bcs(i);
